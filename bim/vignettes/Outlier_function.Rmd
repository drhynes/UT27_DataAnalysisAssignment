...
outlier_check_example <- check_for_outliers(
  ...
  cell_variables = c("Brain_T_Cell_Counts", "Brain_Microglia_Counts","Brain_Neutrophil_Counts"), # numerical cell variable
  outlier_condition = 1.5) # condition to test for outlier 
